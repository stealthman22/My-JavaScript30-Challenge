...
/* 
The click ripple effects happens because the browser does something called a capture (it ripples down after a click) , and then does a bubble (it ripples from top to down).
...
You can wrap this in an of statement.

once: listen for a click and then unbind; It will listen fro a click then unbind the event listener, causing it not to listen for future clicks.
